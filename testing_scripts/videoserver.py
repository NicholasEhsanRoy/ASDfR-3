...
vid = cv2.VideoCapture(cap_path)                      # on Windows, comment this line
# vid = cv2.VideoCapture('/dev/video0', cv2.CAP_DSHOW)     # and uncomment this line.
vid.set(cv2.CAP_PROP_FPS, FPS)
fps, start_time, frames_to_count, count = (0, 0, 20, 0)
do_cap = True
width = WIDTH
height = HEIGHT
print("goint to cap loop")
while vid.isOpened():
