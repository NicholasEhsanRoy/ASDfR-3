...
#define NODE_MAIN_LOGGER_NAME "test_node_exec"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_node::TestNode>";
