...
foreach(_cmake_expected_target IN ITEMS test_node::test_node)
...
# Create imported target test_node::test_node
add_library(test_node::test_node SHARED IMPORTED)

set_target_properties(test_node::test_node PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/usr/include/opencv4;${_IMPORT_PREFIX}/include/test_node;${_IMPORT_PREFIX}/include"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/test_nodeExport-*.cmake")
