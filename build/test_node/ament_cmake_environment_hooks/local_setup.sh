...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/ASDFR/ASDfR-3/install/test_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test_node/environment/library_path.sh"
