...
#include "asdfr_msgs/msg/detail/identified_object__rosidl_typesupport_fastrtps_c.h"
...
using _IdentifiedObject__ros_msg_type = asdfr_msgs__msg__IdentifiedObject;
...
{
  const _IdentifiedObject__ros_msg_type * ros_message = static_cast<const _IdentifiedObject__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = asdfr_msgs__msg__IdentifiedObject;
    is_plain =
      (
      offsetof(DataType, r) +
      last_member_size
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const asdfr_msgs__msg__IdentifiedObject * ros_message = static_cast<const asdfr_msgs__msg__IdentifiedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_asdfr_msgs__msg__IdentifiedObject(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  asdfr_msgs__msg__IdentifiedObject * ros_message = static_cast<asdfr_msgs__msg__IdentifiedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_asdfr_msgs__msg__IdentifiedObject(cdr, ros_message);
}

static uint32_t _IdentifiedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_asdfr_msgs__msg__IdentifiedObject(
...
static size_t _IdentifiedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_asdfr_msgs__msg__IdentifiedObject(
...
static message_type_support_callbacks_t __callbacks_IdentifiedObject = {
  "asdfr_msgs::msg",
  "IdentifiedObject",
...
static rosidl_message_type_support_t _IdentifiedObject__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IdentifiedObject,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, asdfr_msgs, msg, IdentifiedObject)() {
  return &_IdentifiedObject__type_support;
}
