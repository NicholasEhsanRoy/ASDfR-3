...
static const _IdentifiedObject_type_support_symbol_names_t _IdentifiedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, asdfr_msgs, msg, IdentifiedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, asdfr_msgs, msg, IdentifiedObject)),
  }
};
...
{
  return &::asdfr_msgs::msg::rosidl_typesupport_cpp::IdentifiedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, asdfr_msgs, msg, IdentifiedObject)() {
  return get_message_type_support_handle<asdfr_msgs::msg::IdentifiedObject>();
}
