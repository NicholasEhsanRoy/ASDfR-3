...
bool asdfr_msgs__msg__identified_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("asdfr_msgs.msg._identified_object.IdentifiedObject", full_classname_dest, 50) == 0);
  }
  asdfr_msgs__msg__IdentifiedObject * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of IdentifiedObject */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("asdfr_msgs.msg._identified_object");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IdentifiedObject");
