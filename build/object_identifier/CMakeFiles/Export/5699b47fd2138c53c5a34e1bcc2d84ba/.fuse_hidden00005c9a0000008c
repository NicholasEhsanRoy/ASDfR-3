...
foreach(_cmake_expected_target IN ITEMS object_identifier::object_identifier)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/object_identifierExport-*.cmake")
