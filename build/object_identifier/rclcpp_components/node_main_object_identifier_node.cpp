...
#define NODE_MAIN_LOGGER_NAME "object_identifier_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobject_identifier.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<object_identifier::ObjectIdentifier>";
