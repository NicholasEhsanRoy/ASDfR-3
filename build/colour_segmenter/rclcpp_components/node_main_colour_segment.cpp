...
#define NODE_MAIN_LOGGER_NAME "colour_segment"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcolour_segmenter.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<colour_segmenter::ColourSegmenter>";
