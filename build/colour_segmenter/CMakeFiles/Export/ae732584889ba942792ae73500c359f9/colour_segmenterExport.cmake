...
foreach(_cmake_expected_target IN ITEMS colour_segmenter::colour_segmenter)
...
# Create imported target colour_segmenter::colour_segmenter
add_library(colour_segmenter::colour_segmenter SHARED IMPORTED)

set_target_properties(colour_segmenter::colour_segmenter PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/colour_segmenter;${_IMPORT_PREFIX}/include"
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/colour_segmenterExport-*.cmake")
